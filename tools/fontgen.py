...
#
# Vendored from the Pebble SDK 4.33.1 (sdk-core/pebble/common/tools/font/
# fontgen.py) with one change, marked "Headway" below.
...
class Font:
    ...
    def glyph_bits(self, codepoint, gindex):
        flags = (
            ...
            # Headway: force the auto-hinter. A TrueType font is always taken
            # to be hinted, and Barlow's own hints rasterise unevenly in
            # one-bit at label sizes; the auto-hinter's mono mode keeps its
            # stems to whole pixels.
